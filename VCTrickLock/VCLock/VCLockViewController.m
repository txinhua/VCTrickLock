...
#import "VCLockViewController.h"


@interface VCLockViewController ()
{
...
@implementation VCLockViewController

- (void)viewDidLoad {
    
    [super viewDidLoad];
    
    _passwordUIValidation = [[MyPasswordUIValidation alloc]initIn:self.passwordStackView];
    
    __weak VCLockViewController *weakSelf = self;
    ...
    [_passwordUIValidation.view rearrangeForVisualEffectView:self];
